...
declare const UserCreateDto_base: import("@nestjs/common").Type<Omit<UserBase, "id" | "loginId">>;
...
declare const UserUpdateDto_base: import("@nestjs/common").Type<Partial<Omit<UserBase, "id" | "loginId">>>;
